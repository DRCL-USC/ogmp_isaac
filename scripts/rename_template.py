...
It renames all the occurrences of ogmp_isaac (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the ogmp_isaac folder
        os.rename(
            os.path.join(root_dir_path, "exts", "ogmp_isaac", "ogmp_isaac"),
            os.path.join(root_dir_path, "exts", "ogmp_isaac", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "ogmp_isaac"), os.path.join(root_dir_path, "exts", new_name))
